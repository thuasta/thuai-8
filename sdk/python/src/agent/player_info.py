...
class WeaponInfo:
    ...
    def __str__(self):
        return f"Weapon(attack_speed={self.attack_speed}, bullet_speed={self.bullet_speed}, " \
...
class ArmorInfo:
    ...
    def __str__(self):
        return f"Armor(can_reflect={self.can_reflect}, armor_value={self.armor_value}, " \
...
class SkillInfo:
    ...
    def __str__(self):
        return f"Skill(name={self.name}, max_cooldown={self.max_cooldown}, " \
...
class PlayerInfo:
    ...
    def __str__(self) -> str:
        return f"PlayerInfo{{token: {self.token}, weapon: {self.weapon}, armor: {self.armor}, skill: {self.skill}, position: {self.position}}}"
